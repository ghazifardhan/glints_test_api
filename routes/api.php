    ...
    $api->group(['middleware' => ['api.auth']], function (Router $api) {
        ...
        */
        $api->group(['prefix' => 'transactions'], function (Router $api) {
            $api->get('/', 'App\Http\Controllers\TransactionControllerController@getAll');
            $api->get('/{uuid}', 'App\Http\Controllers\TransactionControllerController@get');
            $api->post('/', 'App\Http\Controllers\TransactionControllerController@post');
            $api->patch('/{uuid}', 'App\Http\Controllers\TransactionControllerController@patch');
            $api->delete('/{uuid}', 'App\Http\Controllers\TransactionControllerController@delete');
        });
    });
});
